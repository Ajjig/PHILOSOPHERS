...
It contains 2 different programs (processes part and threads part) simulating a twist of the famous Dining Philosophers problem, all with the same basic rules.
